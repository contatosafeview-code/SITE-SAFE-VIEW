    ...
    <section id="features" className="py-24 bg-slate-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-2">Diferenciais</h2>
          <h3 className="text-4xl font-bold text-white">Por que escolher a SafeView?</h3>
          <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
            Líderes em instalação com tecnologia de rastreio de lote e materiais de procedência comprovada.
          </p>
        </div>
